...
window.LSM = (function () {
  ...
  var DOMAINS = {
    ...
    gend:  { name: '性别光谱域', note: '思维与表达的气质倾向（认知性别），与生理性别无关，人人兼具两种取向' }
  };
  ...
  var DIMS = [
    ...
    {
      key: 'tools', name: '工具效能', domain: 'gend',
      desc: '面对任务时偏向"工具性"的认知风格：目标导向、直接决断、依赖逻辑与行动。与生理性别无关，只是一种思维气质。',
      low:  '你较少采用直接、以结果为导向的处理方式，更常在行动前充分考虑关系与感受。这让你温和而周到，但复杂任务中可能略显犹豫。可在重要事务中练习"先定目标，再行动"的小循环。',
      mid:  '你兼具任务导向与关系考量，能在"推进事情"与"照顾感受"之间切换。关键是在需要果断的时刻，愿意给出清晰的决定并推进。',
      high: '你具备较强的工具效能风格：目标清晰、决断直接、习惯用逻辑和行动推进任务。这是高效的执行气质。注意在纯粹追求结果时，给关系与感受留出空间。'
    },
    {
      key: 'expr', name: '表达温暖', domain: 'gend',
      desc: '面对关系时偏向"表达性"的认知风格：关注情感、主动表达、共情与关系维系。与生理性别无关，只是一种关怀气质。',
      low:  '你较少主动表露情感，更习惯把感受留在心里、用行动而非言语表达关心。这让你克制而可靠，但亲近的人可能感到难以靠近。可在安全关系中练习小步的"情感表达"。',
      mid:  '你能在需要时表达情感与关怀，但深浅随对象与场合而异。保持"表里如一"：当你关心某人，试着让语言与行动同步传递这份温度。',
      high: '你具备较强的表达温暖风格：情感细腻、善于表达关怀与共情，很会经营关系。这是连接的能力。注意在付出关怀的同时，也照顾好自己的情绪边界，避免过度消耗。'
    }
  ];
